...
describe('OmpCommandMetadataProbe', () => {
  it('loads commands through the supported Omp discovery command', async () => {
    const kernel = {
    ...
    const host = {
      getResolvedProviderCliPath: jest.fn(async () => '/configured/omp'),
      settings: {},
    } as unknown as ProviderHost;
    const probe = new OmpCommandMetadataProbe(host, () => kernel as any);
